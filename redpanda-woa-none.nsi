...
Unicode True
!include "config.nsh"
!define FINALNAME "RedPanda.CPP.${DEVCPP_VERSION}.WoA.None.exe"
...
Section "$(SectionMainName)" SectionMain
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\RedPanda-C++" "Publisher" "Cyano Hao (c@cyano.cn)"
